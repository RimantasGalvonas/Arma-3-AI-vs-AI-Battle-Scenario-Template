...
G_Revive_DownsPerLife = 1; //Number of times unit can go Incapacitated in single life. 0 = Unlimited, integer > 0 = limit of downs per life.
...
G_Revive_Messages = 0; //Chat messages upon incapacitation and revive. 0 = None. 1 = Friendly only. 2 = All.
